...
[DependsOn(
    ...
    typeof(ElearningWebModule),
    typeof(ElearningApplicationTestModule),
    typeof(ElearningEntityFrameworkCoreTestModule)
)]
public class ElearningWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(ElearningWebModule).Assembly));
        });
